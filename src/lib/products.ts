...
export const products: Product[] = [
    {
        ...
        tagline: 'مشابه چت‌جی‌پی‌تی — بدون VPN، بدون پرداخت ارزی',
        shortDescription: 'دسترسی فارسی به بهترین مدل‌های هوش مصنوعی دنیا؛ GPT-4، Claude و Gemini با اشتراک ریالی و پشتیبانی فارسی.',
        fullDescription: 'برای استفاده از مدل‌های هوش مصنوعی نباید درگیر VPN، پرداخت ارزی و رابط‌های ناآشنا باشید. این دستیار مشابه چت‌جی‌پی‌تی همین مسأله را حل می‌کند: یک پلتفرم چت هوشمند فارسی با دسترسی به مدل‌هایی مثل GPT-4، Claude و Gemini، اشتراک ماهانه ریالی، رابط کاربری فارسی و داده‌هایی که در ایران می‌مانند. هزاران کاربر هر روز از آن استفاده می‌کنند.',
        problemsSolved: [
            'برای هر بار استفاده از ابزارهای مشابه چت‌جی‌پی‌تی باید VPN روشن کنید',
            'پرداخت ارزی برای اشتراک سرویس‌های هوش مصنوعی دسترسی را سخت می‌کند',
