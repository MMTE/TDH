    ...
    items: [
      {
        ...
        a: 'تکین داده هوشمند نرم‌افزار و خدمات کاربردی می‌سازد؛ از سیستم CRM جامع و راه‌حل‌های فروشگاهی تا ابزارهای جستجو و تحلیل اطلاعات و توسعه نرم‌افزار سفارشی.',
      },
      {
      ...
      },
      {
        ...
        a: 'محصولات ما بسته به مرحله توسعه‌شان متفاوت‌اند. برخی آماده استفاده‌اند و برخی دیگر نیازمند نصب، تنظیم یا سفارشی‌سازی بر اساس نیاز شما. در جلسه اول، مسیر مناسب را مشخص می‌کنیم.',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: 'CRM360 چه امکاناتی دارد؟',
        a: 'CRM360 پلتفرم جامع مدیریت ارتباط با مشتریان به زبان فارسی است؛ با تقویم شمسی، pipeline فروش، صدور فاکتور، چت Real-time، سیستم تیکت و بورد وظایف.',
      },
      {
        q: 'Factorino برای چه کسب‌وکارهایی مناسب است؟',
        a: 'Factorino برای فروشگاه‌های اینترنتی و کسب‌وکارهای آنلاین طراحی شده؛ مدیریت سفارشات، موجودی، مشتریان و تحلیل فروش را در یک پلتفرم یکپارچه انجام می‌دهد.',
      },
      {
        q: 'Topinar چه مسأله‌ای را حل می‌کند؟',
        a: 'Topinar جستجوی سریع و تحلیل یکپارچه اطلاعات سازمانی را فراهم می‌کند؛ به‌جای جستجو در چند ابزار مجزا، تمام داده‌ها از یک نقطه قابل دسترسی و تحلیل هستند.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'به نوع کار بستگی دارد. راه‌اندازی یک محصول آماده می‌تواند خیلی سریع انجام شود، اما توسعه سفارشی یا طراحی زیرساخت نیاز به تحلیل دقیق‌تر دارد. بعد از جلسه مسأله‌شناسی، زمان‌بندی شفاف ارائه می‌کنیم.',
      },
      {
