const reasons = [
  ...
  { number: '05', title: 'اول خودمان به ابزارها اعتماد کردیم', description: 'chatgpt.ir هر روز هزاران مکالمه فارسی را پردازش می‌کند. ServerGuard برای مراقبت از سرورهای خودمان ساخته شد و Watch Tower از نیاز واقعی به اعلان‌رسانی یکپارچه آمد.' },
];
